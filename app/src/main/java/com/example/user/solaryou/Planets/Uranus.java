 ...
 */
public class Uranus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.uranus_fragment, container, false);
        return rootView;
    }
    ...
    private View.OnClickListener next_Listener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if(rb1.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Uranian units to Mercury units?",Toast.LENGTH_SHORT).show();
                ...
                double age = (yearValue*(365*84) + dayValue)/88;
            ...
            if(rb2.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Uranian units to Venusian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(8.87);

                double age = (yearValue*(365*84) + dayValue)/225;
            ...
            if(rb3.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Uranian units to Earth units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(9.8);

                double age = (yearValue*(365*84) + dayValue)/365;
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb4.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Uranian units to Mercurian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/8.87;
                weight = weight*(3.7);

                double age = (yearValue*(365*84) + dayValue)/(687);
            ...
            if(rb5.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Uranian units to Jovian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(24.92);

                double age = (yearValue*(365*84) + dayValue)/(11.8*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb6.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Uranian units to Saturnian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(10.44);

                double age = (yearValue*(365*84) + dayValue)/(29.4*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb7.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Uranian units to Neptunian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(11.15);
