...
public class Venus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.venus_fragment, container, false);
        return rootView;
    }
    ...
    private View.OnClickListener next_Listener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if(rb2.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Venusian units to Earth units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(9.8);

                double age = (yearValue*225 + dayValue)/365;
            ...
            if(rb3.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Venusian units to Martian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(3.71);

                double age = (yearValue*225 + dayValue)/687;
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb4.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Venusian units to Jovian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(24.92);

                double age = (yearValue*225 + dayValue)/(11.8*365);
            ...
            if(rb5.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Venusian units to Saturnian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(10.44);

                double age = (yearValue*225 + dayValue)/(29.4*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb6.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Venusian units to Uranian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(8.87);

                double age = (yearValue*225 + dayValue)/(84*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb7.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Venusian units to Neptunian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(8.87);
                weight = weight*(11.15);

                double age = (yearValue*225 + dayValue)/(164*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
