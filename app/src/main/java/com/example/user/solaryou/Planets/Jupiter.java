 ...
 */
public class Jupiter extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.jupiter_fragment, container, false);
        return rootView;
    }
    ...
    private View.OnClickListener next_Listener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if(rb1.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Jovian units to Mercurian units?",Toast.LENGTH_SHORT).show();
                //weight on earth / surface gravity on jupiter = mass
                //mass*surface gravity of other planet
                double weight = weightValue/(24.92);
                weight = weight*(3.7);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                //365 = 1 earth year so years*365 / earth days in year on other planet
                double age = (yearValue*(11.8*365) + dayValue)/88;
            ...
            if(rb2.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Jovian units to Venusian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(24.92);
                weight = weight*(8.87);

                double age = (yearValue*(11.8*365) + dayValue)/225;
            ...
            if(rb3.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Jovian units to Earth units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(23.1);
                weight = weight*(9.798);

                double age = (yearValue*(365*11.8) + dayValue)/365;
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb4.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Jovian units to Martian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(24.92);
                weight = weight*(3.7);

                double age = (yearValue*(365*11.8) + dayValue)/(11.8*365);
            ...
            if(rb5.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Jovian units to Saturnian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(24.92);
                weight = weight*(10.44);
            ...
            if(rb6.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Jovian units to Uranian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(24.92);
                weight = weight*(8.87);

                double age = (yearValue*(365*11.8) + dayValue)/(84*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb7.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Jovian units to Neptunian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(24.92);
                weight = weight*(11.15);

                double age = (yearValue*(365*11.8) + dayValue)/(164*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
