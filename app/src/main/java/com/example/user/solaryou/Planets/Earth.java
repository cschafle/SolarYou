...
public class Earth extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.earth_fragment, container, false);
        return rootView;
    }
    ...
    private View.OnClickListener next_Listener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if(rb2.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Earth units to Venusian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(9.8);
                weight = weight*(8.87);

                double age = (yearValue*365 + dayValue)/225;
            ...
            if(rb3.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Earth units to Martian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(9.8);
                weight = weight*(3.71);

                double age = (yearValue*365 + dayValue)/687;
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb4.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Earth units to Jovian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(9.8);
                weight = weight*(24.92);

                double age = (yearValue*365 + dayValue)/(11.8*365);
            ...
            if(rb5.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Earth units to Saturnian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(9.8);
                weight = weight*(10.44);
                ...
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
                TextView t = (TextView) getView().findViewById(R.id.displayResults);
                t.setText("Your weight on Saturnian is: " + weight + " and your age is: " + age);

            }
            if(rb6.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Earth units to Uranian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(9.8);
                weight = weight*(8.87);
            ...
            if(rb7.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Earth units to Neptunian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(9.8);
                weight = weight*(11.15);
