...
public class Mars extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.mars_fragment, container, false);
        return rootView;
    }
    ...
    public void onActivityCreated (Bundle savedInstanceState) {
        ...
        Button rb3 = (Button) getActivity().findViewById(R.id.radio_earth);
    ...
    private View.OnClickListener next_Listener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            RadioButton rb3 = (RadioButton)getActivity().findViewById((R.id.radio_earth));
            ...
            if(rb2.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Martian units to Venusian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(3.71);
                weight = weight*(8.87);

                double age = (yearValue*687 + dayValue)/225;
            ...
            if(rb3.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Martian units to Earth units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(3.71);
                weight = weight*(9.8);

                double age = (yearValue*687 + dayValue)/365;
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb4.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Martian units to Jovian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(3.71);
                weight = weight*(24.92);

                double age = (yearValue*687 + dayValue)/(11.8*365);
            ...
            if(rb5.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Martian units to Saturnian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(3.71);
                weight = weight*(10.44);

                double age = (yearValue*365 + dayValue)/(29.4*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb6.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Martian units to Uranian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(3.71);
                weight = weight*(8.87);

                double age = (yearValue*365 + dayValue)/(84*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
            ...
            if(rb7.isChecked() == true) {
                Toast.makeText(getActivity(),"Convert Martian units to Neptunian units?",Toast.LENGTH_SHORT).show();
                double weight = weightValue/(3.71);
                weight = weight*(11.15);

                double age = (yearValue*365 + dayValue)/(164*365);
                weight = (double)Math.round(weight * Math.pow(10, 2))
                        / Math.pow(10, 2);
                age = (double)Math.round(age * Math.pow(10, 2))
                        / Math.pow(10, 2);
